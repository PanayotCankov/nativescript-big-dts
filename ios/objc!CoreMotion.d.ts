...
declare class CMSensorRecorder extends NSObject {
	...
	accelerometerDataFromTo(fromDate: Date, toDate: Date): CMSensorDataList;

	accelerometerDataSince(identifier: number): CMSensorDataList;

	recordAccelerometerFor(duration: number): void;
